  ...
  return (
    <div>
        <form className='w-full flex flex-col gap-4' action={loginWithCredentials}>
            ...
            <div>
                <label className='block text-sm font-medium text-gray-200' htmlFor='Email'>Password</label>
                <input type='password' placeholder='Password' name='password' id="password" className='mt-1 w-full px-4 py-2 h-10 rounded-md border border-gray-200 bg-white text-sm text-gray-700' />
            </div>
            <div className='mt-4'>
                <AuthButton />
            </div>
